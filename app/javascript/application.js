...
// Scroll up activation
    ...
    */
    ...
    /*
      2. product swiper column4 activation
    */
    let swiper2 = new Swiper(".product__swiper--activation", {
        slidesPerView: 4,
        loop: true,
        clickable: true,
        spaceBetween: 30,
    ...
    /*
      3. product swiper column4 style2 activation
    */
    let swiper3 = new Swiper(".product__swiper--column4__style2", {
        slidesPerView: 4,
        loop: true,
        clickable: true,
        spaceBetween: 30,
    ...
    /*
      4. single product nav activation
    */
    let swiper4 = new Swiper(".single__product--nav", {
        loop: true,
        spaceBetween: 20,
        slidesPerView: 5,
        freeMode: true,
    ...
    */
    ...
    /*
      6. blog swiper activation
    */
    let swiper6 = new Swiper(".blog__swiper--activation", {
        slidesPerView: 3,
        loop: true,
        clickable: true,
        spaceBetween: 30,
    ...
    /*
      7. testimonial swiper activation
    */
    let swiper7 = new Swiper(".testimonial__swiper--activation", {
        slidesPerView: 2,
        loop: true,
        clickable: true,
        spaceBetween: 30,
    ...
    /*
      8. quickview swiper activation
    */
    let swiper8 = new Swiper(".quickview__swiper--activation", {
        slidesPerView: 1,
        loop: true,
        clickable: true,
        spaceBetween: 30,
    ...
    /*
      9. product details media swiper activation
    */
    let swiper9 = new Swiper(".product__media--nav", {
        loop: true,
        spaceBetween: 10,
        slidesPerView: 4,
        freeMode: true,
    ...
    let swiper91 = new Swiper(".product__media--preview", {
        loop: true,
        spaceBetween: 10,
        thumbs: {
            swiper: swiper9,
    ...
    /*
      10. testimonial active one activation
    */
    let swiper10 = new Swiper(".testimonial__active--one", {
        loop: true,
        spaceBetween: 20,
        slidesPerView: 5,
        centeredSlides: true,
    ...
    let swiper11 = new Swiper(".testimonial__active--two", {
        loop: true,
        spaceBetween: 10,
        thumbs: {
            swiper: swiper10,
